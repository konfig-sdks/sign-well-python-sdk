...
class RequiredCopiedPlaceholdersMapItem(TypedDict):
    # Name of the placeholder.
    name: str

class OptionalCopiedPlaceholdersMapItem(TypedDict, total=False):
...
class CopiedPlaceholdersMapItem(RequiredCopiedPlaceholdersMapItem, OptionalCopiedPlaceholdersMapItem):
    pass
