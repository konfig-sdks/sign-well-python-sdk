...
class RequiredFieldsMapItemItem(TypedDict):
...
class OptionalFieldsMapItemItem(TypedDict, total=False):
...
class FieldsMapItemItem(RequiredFieldsMapItemItem, OptionalFieldsMapItemItem):
    pass
