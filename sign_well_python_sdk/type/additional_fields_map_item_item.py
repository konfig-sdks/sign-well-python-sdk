...
class RequiredAdditionalFieldsMapItemItem(TypedDict):
...
class OptionalAdditionalFieldsMapItemItem(TypedDict, total=False):
...
class AdditionalFieldsMapItemItem(RequiredAdditionalFieldsMapItemItem, OptionalAdditionalFieldsMapItemItem):
    pass
