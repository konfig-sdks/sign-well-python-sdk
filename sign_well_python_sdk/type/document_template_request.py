...
class RequiredDocumentTemplateRequest(TypedDict):
    files: FilesMap

    placeholders: PlaceholdersMap

class OptionalDocumentTemplateRequest(TypedDict, total=False):
    ...
    copied_placeholders: CopiedPlaceholdersMap
    ...
    fields: FieldsForTemplateMap

    attachment_requests: AttachmentRequestsForTemplateMap

class DocumentTemplateRequest(RequiredDocumentTemplateRequest, OptionalDocumentTemplateRequest):
    pass
