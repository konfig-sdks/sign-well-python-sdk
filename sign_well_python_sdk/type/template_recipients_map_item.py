...
class RequiredTemplateRecipientsMapItem(TypedDict):
...
class OptionalTemplateRecipientsMapItem(TypedDict, total=False):
...
class TemplateRecipientsMapItem(RequiredTemplateRecipientsMapItem, OptionalTemplateRecipientsMapItem):
    pass
