...
class RequiredPlaceholdersMapItem(TypedDict):
...
class OptionalPlaceholdersMapItem(TypedDict, total=False):
...
class PlaceholdersMapItem(RequiredPlaceholdersMapItem, OptionalPlaceholdersMapItem):
    pass
