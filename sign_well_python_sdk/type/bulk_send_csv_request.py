...
class RequiredBulkSendCsvRequest(TypedDict):
    template_ids: BulkSendTemplateIdsParamMap

    # A RFC 4648 base64 string of the template CSV file to be validated.
    bulk_send_csv: str

class OptionalBulkSendCsvRequest(TypedDict, total=False):
    pass

class BulkSendCsvRequest(RequiredBulkSendCsvRequest, OptionalBulkSendCsvRequest):
    pass
