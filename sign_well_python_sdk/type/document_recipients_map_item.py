...
class RequiredDocumentRecipientsMapItem(TypedDict):
...
class OptionalDocumentRecipientsMapItem(TypedDict, total=False):
...
class DocumentRecipientsMapItem(RequiredDocumentRecipientsMapItem, OptionalDocumentRecipientsMapItem):
    pass
