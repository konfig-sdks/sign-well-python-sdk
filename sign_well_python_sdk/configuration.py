...
from sign_well_python_sdk.exceptions_base import ApiValueError
from sign_well_python_sdk.exceptions import ClientConfigurationError
from sign_well_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = sign_well_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://www.signwell.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("sign_well_python_sdk")
        ...
        return [
            {
                ...
                'variables': {
                    'defaultHost': {
                        'description': "No description provided",
                        'default_value': "www.signwell.com",
                        }
                    }
            }
        ]
