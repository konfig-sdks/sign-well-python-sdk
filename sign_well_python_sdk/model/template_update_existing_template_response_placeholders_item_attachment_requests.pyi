...
class TemplateUpdateExistingTemplateResponsePlaceholdersItemAttachmentRequests(
    schemas.ListSchema
):
    """NOTE:
    ...
    def __new__(
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TemplateUpdateExistingTemplateResponsePlaceholdersItemAttachmentRequests':
        return super().__new__(
            cls,
            arg,
            _configuration=_configuration,
