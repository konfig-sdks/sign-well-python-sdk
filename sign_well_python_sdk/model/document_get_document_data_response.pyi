...
class DocumentGetDocumentDataResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metadata() -> typing.Type['DocumentGetDocumentDataResponseMetadata']:
                return DocumentGetDocumentDataResponseMetadata
            ...
            @staticmethod
            def fields() -> typing.Type['DocumentGetDocumentDataResponseFields']:
                return DocumentGetDocumentDataResponseFields
        
            @staticmethod
            def files() -> typing.Type['DocumentGetDocumentDataResponseFiles']:
                return DocumentGetDocumentDataResponseFiles
        
            @staticmethod
            def copied_contacts() -> typing.Type['DocumentGetDocumentDataResponseCopiedContacts']:
                return DocumentGetDocumentDataResponseCopiedContacts
        
            @staticmethod
            def recipients() -> typing.Type['DocumentGetDocumentDataResponseRecipients']:
                return DocumentGetDocumentDataResponseRecipients
            __annotations__ = {
                "id": id,
                "archived": archived,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'DocumentGetDocumentDataResponseMetadata': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'DocumentGetDocumentDataResponseFields': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["files"]) -> 'DocumentGetDocumentDataResponseFiles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["copied_contacts"]) -> 'DocumentGetDocumentDataResponseCopiedContacts': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recipients"]) -> 'DocumentGetDocumentDataResponseRecipients': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['DocumentGetDocumentDataResponseMetadata', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['DocumentGetDocumentDataResponseFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["files"]) -> typing.Union['DocumentGetDocumentDataResponseFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["copied_contacts"]) -> typing.Union['DocumentGetDocumentDataResponseCopiedContacts', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recipients"]) -> typing.Union['DocumentGetDocumentDataResponseRecipients', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        metadata: typing.Union['DocumentGetDocumentDataResponseMetadata', schemas.Unset] = schemas.unset,
        ...
        fields: typing.Union['DocumentGetDocumentDataResponseFields', schemas.Unset] = schemas.unset,
        files: typing.Union['DocumentGetDocumentDataResponseFiles', schemas.Unset] = schemas.unset,
        copied_contacts: typing.Union['DocumentGetDocumentDataResponseCopiedContacts', schemas.Unset] = schemas.unset,
        recipients: typing.Union['DocumentGetDocumentDataResponseRecipients', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
