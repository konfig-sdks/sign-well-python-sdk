...
class TemplateGetTemplateDataResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def fields() -> typing.Type['TemplateGetTemplateDataResponseFields']:
                return TemplateGetTemplateDataResponseFields
        
            @staticmethod
            def files() -> typing.Type['TemplateGetTemplateDataResponseFiles']:
                return TemplateGetTemplateDataResponseFiles
        
            @staticmethod
            def copied_placeholders() -> typing.Type['TemplateGetTemplateDataResponseCopiedPlaceholders']:
                return TemplateGetTemplateDataResponseCopiedPlaceholders
        
            @staticmethod
            def placeholders() -> typing.Type['TemplateGetTemplateDataResponsePlaceholders']:
                return TemplateGetTemplateDataResponsePlaceholders
            __annotations__ = {
                "id": id,
                "archived": archived,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'TemplateGetTemplateDataResponseFields': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["files"]) -> 'TemplateGetTemplateDataResponseFiles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["copied_placeholders"]) -> 'TemplateGetTemplateDataResponseCopiedPlaceholders': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["placeholders"]) -> 'TemplateGetTemplateDataResponsePlaceholders': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['TemplateGetTemplateDataResponseFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["files"]) -> typing.Union['TemplateGetTemplateDataResponseFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["copied_placeholders"]) -> typing.Union['TemplateGetTemplateDataResponseCopiedPlaceholders', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["placeholders"]) -> typing.Union['TemplateGetTemplateDataResponsePlaceholders', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        allow_decline: typing.Union[MetaOapg.properties.allow_decline, None, str, schemas.Unset] = schemas.unset,
        allow_reassign: typing.Union[MetaOapg.properties.allow_reassign, None, str, schemas.Unset] = schemas.unset,
        api_application_id: typing.Union[MetaOapg.properties.api_application_id, None, str, schemas.Unset] = schemas.unset,
        decline_redirect_url: typing.Union[MetaOapg.properties.decline_redirect_url, None, str, schemas.Unset] = schemas.unset,
        expires_in: typing.Union[MetaOapg.properties.expires_in, None, str, schemas.Unset] = schemas.unset,
        redirect_url: typing.Union[MetaOapg.properties.redirect_url, None, str, schemas.Unset] = schemas.unset,
        reminders: typing.Union[MetaOapg.properties.reminders, None, str, schemas.Unset] = schemas.unset,
        ...
        fields: typing.Union['TemplateGetTemplateDataResponseFields', schemas.Unset] = schemas.unset,
        files: typing.Union['TemplateGetTemplateDataResponseFiles', schemas.Unset] = schemas.unset,
        copied_placeholders: typing.Union['TemplateGetTemplateDataResponseCopiedPlaceholders', schemas.Unset] = schemas.unset,
        placeholders: typing.Union['TemplateGetTemplateDataResponsePlaceholders', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
