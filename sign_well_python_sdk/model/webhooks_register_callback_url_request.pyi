...
class WebhooksRegisterCallbackUrlRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["callback_url", "api_application_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["callback_url", "api_application_id", ], str]):
