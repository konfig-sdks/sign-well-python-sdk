...
class DocumentResponseRecipientsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def attachment_requests() -> typing.Type['DocumentResponseRecipientsItemAttachmentRequests']:
                return DocumentResponseRecipientsItemAttachmentRequests
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attachment_requests"]) -> 'DocumentResponseRecipientsItemAttachmentRequests': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "body", "message", "subject", "send_email", "send_email_delay", "attachment_requests", "passcode", "status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attachment_requests"]) -> typing.Union['DocumentResponseRecipientsItemAttachmentRequests', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "email", "body", "message", "subject", "send_email", "send_email_delay", "attachment_requests", "passcode", "status", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        attachment_requests: typing.Union['DocumentResponseRecipientsItemAttachmentRequests', schemas.Unset] = schemas.unset,
    ...
    ) -> 'DocumentResponseRecipientsItem':
