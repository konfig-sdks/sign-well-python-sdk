...
class FieldsMap(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FieldsMapItem']:
            return FieldsMapItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['FieldsMapItem'], typing.List['FieldsMapItem']],
    ...
    def __getitem__(self, i: int) -> 'FieldsMapItem':
