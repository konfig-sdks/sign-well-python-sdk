...
class PlaceholdersMapItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
