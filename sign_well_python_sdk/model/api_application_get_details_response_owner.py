...
class ApiApplicationGetDetailsResponseOwner(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "account_id", "name", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "account_id", "name", "email", ], str]):
