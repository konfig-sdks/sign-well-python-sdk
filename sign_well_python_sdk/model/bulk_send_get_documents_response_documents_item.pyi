...
class BulkSendGetDocumentsResponseDocumentsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metadata() -> typing.Type['BulkSendGetDocumentsResponseDocumentsItemMetadata']:
                return BulkSendGetDocumentsResponseDocumentsItemMetadata
            ...
            @staticmethod
            def fields() -> typing.Type['BulkSendGetDocumentsResponseDocumentsItemFields']:
                return BulkSendGetDocumentsResponseDocumentsItemFields
        
            @staticmethod
            def files() -> typing.Type['BulkSendGetDocumentsResponseDocumentsItemFiles']:
                return BulkSendGetDocumentsResponseDocumentsItemFiles
        
            @staticmethod
            def copied_contacts() -> typing.Type['BulkSendGetDocumentsResponseDocumentsItemCopiedContacts']:
                return BulkSendGetDocumentsResponseDocumentsItemCopiedContacts
        
            @staticmethod
            def recipients() -> typing.Type['BulkSendGetDocumentsResponseDocumentsItemRecipients']:
                return BulkSendGetDocumentsResponseDocumentsItemRecipients
            __annotations__ = {
                "id": id,
                "archived": archived,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'BulkSendGetDocumentsResponseDocumentsItemMetadata': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'BulkSendGetDocumentsResponseDocumentsItemFields': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["files"]) -> 'BulkSendGetDocumentsResponseDocumentsItemFiles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["copied_contacts"]) -> 'BulkSendGetDocumentsResponseDocumentsItemCopiedContacts': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recipients"]) -> 'BulkSendGetDocumentsResponseDocumentsItemRecipients': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['BulkSendGetDocumentsResponseDocumentsItemMetadata', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['BulkSendGetDocumentsResponseDocumentsItemFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["files"]) -> typing.Union['BulkSendGetDocumentsResponseDocumentsItemFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["copied_contacts"]) -> typing.Union['BulkSendGetDocumentsResponseDocumentsItemCopiedContacts', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recipients"]) -> typing.Union['BulkSendGetDocumentsResponseDocumentsItemRecipients', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        metadata: typing.Union['BulkSendGetDocumentsResponseDocumentsItemMetadata', schemas.Unset] = schemas.unset,
        ...
        fields: typing.Union['BulkSendGetDocumentsResponseDocumentsItemFields', schemas.Unset] = schemas.unset,
        files: typing.Union['BulkSendGetDocumentsResponseDocumentsItemFiles', schemas.Unset] = schemas.unset,
        copied_contacts: typing.Union['BulkSendGetDocumentsResponseDocumentsItemCopiedContacts', schemas.Unset] = schemas.unset,
        recipients: typing.Union['BulkSendGetDocumentsResponseDocumentsItemRecipients', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'BulkSendGetDocumentsResponseDocumentsItem':
        return super().__new__(
            cls,
            *args,
            id=id,
