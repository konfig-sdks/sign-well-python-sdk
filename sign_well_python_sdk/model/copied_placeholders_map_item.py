...
class CopiedPlaceholdersMapItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
