...
class FieldsForTemplateMap(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FieldsForTemplateMapItem']:
            return FieldsForTemplateMapItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['FieldsForTemplateMapItem'], typing.List['FieldsForTemplateMapItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'FieldsForTemplateMap':
    ...
    def __getitem__(self, i: int) -> 'FieldsForTemplateMapItem':
