...
class DocumentTemplateResponseCopiedPlaceholdersItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "placeholder_id", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["placeholder_id"]) -> typing.Union[MetaOapg.properties.placeholder_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "placeholder_id", "preassigned_recipient_name", "preassigned_recipient_email", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        placeholder_id: typing.Union[MetaOapg.properties.placeholder_id, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'DocumentTemplateResponseCopiedPlaceholdersItem':
