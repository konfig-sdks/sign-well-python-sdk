...
class AdditionalFilesMapItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "file_url", "file_base64", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "file_url", "file_base64", ], str]):
