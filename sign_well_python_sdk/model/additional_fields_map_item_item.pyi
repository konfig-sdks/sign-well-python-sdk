...
class AdditionalFieldsMapItemItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x", "y", "page", "recipient_id", "type", "required", "label", "value", "api_id", "validation", "fixed_width", "lock_sign_date", "date_format", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x", "y", "page", "recipient_id", "type", "required", "label", "value", "api_id", "validation", "fixed_width", "lock_sign_date", "date_format", ], str]):
