...
class TemplateCreateNewResponseFieldsItemItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "page", "required", "type", "value", "width", "x", "y", "date_format", "formula", "lock_sign_date", "placeholder_name", "fixed_width", "label", "validation", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "page", "required", "type", "value", "width", "x", "y", "date_format", "formula", "lock_sign_date", "placeholder_name", "fixed_width", "label", "validation", ], str]):
    ...
    ) -> 'TemplateCreateNewResponseFieldsItemItem':
        return super().__new__(
            cls,
            *args,
            api_id=api_id,
