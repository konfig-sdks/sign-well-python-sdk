...
class TemplateCreateNewResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metadata() -> typing.Type['TemplateCreateNewResponseMetadata']:
                return TemplateCreateNewResponseMetadata
            apply_signing_order = schemas.BoolSchema
            message = schemas.StrSchema
            subject = schemas.StrSchema
        
            @staticmethod
            def fields() -> typing.Type['TemplateCreateNewResponseFields']:
                return TemplateCreateNewResponseFields
        
            @staticmethod
            def files() -> typing.Type['TemplateCreateNewResponseFiles']:
                return TemplateCreateNewResponseFiles
        
            @staticmethod
            def copied_placeholders() -> typing.Type['TemplateCreateNewResponseCopiedPlaceholders']:
                return TemplateCreateNewResponseCopiedPlaceholders
        
            @staticmethod
            def placeholders() -> typing.Type['TemplateCreateNewResponsePlaceholders']:
                return TemplateCreateNewResponsePlaceholders
            __annotations__ = {
                "id": id,
                "archived": archived,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'TemplateCreateNewResponseMetadata': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'TemplateCreateNewResponseFields': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["files"]) -> 'TemplateCreateNewResponseFiles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["copied_placeholders"]) -> 'TemplateCreateNewResponseCopiedPlaceholders': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["placeholders"]) -> 'TemplateCreateNewResponsePlaceholders': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['TemplateCreateNewResponseMetadata', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['TemplateCreateNewResponseFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["files"]) -> typing.Union['TemplateCreateNewResponseFiles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["copied_placeholders"]) -> typing.Union['TemplateCreateNewResponseCopiedPlaceholders', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["placeholders"]) -> typing.Union['TemplateCreateNewResponsePlaceholders', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        metadata: typing.Union['TemplateCreateNewResponseMetadata', schemas.Unset] = schemas.unset,
        ...
        fields: typing.Union['TemplateCreateNewResponseFields', schemas.Unset] = schemas.unset,
        files: typing.Union['TemplateCreateNewResponseFiles', schemas.Unset] = schemas.unset,
        copied_placeholders: typing.Union['TemplateCreateNewResponseCopiedPlaceholders', schemas.Unset] = schemas.unset,
        placeholders: typing.Union['TemplateCreateNewResponsePlaceholders', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
