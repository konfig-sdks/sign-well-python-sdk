...
class TemplateUpdateExistingTemplateResponseFieldsItemItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "page", "required", "type", "value", "width", "x", "y", "placeholder_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "page", "required", "type", "value", "width", "x", "y", "placeholder_name", ], str]):
    ...
    ) -> 'TemplateUpdateExistingTemplateResponseFieldsItemItem':
        return super().__new__(
            cls,
            *args,
            api_id=api_id,
