...
class TemplateRecipientsMapItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "email", "name", "placeholder_name", "passcode", "subject", "message", "send_email", "send_email_delay", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "email", "name", "placeholder_name", "passcode", "subject", "message", "send_email", "send_email_delay", ], str]):
