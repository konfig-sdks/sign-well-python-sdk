...
class DocumentUpdateAndSendResponseFieldsItemItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "required", "type", "value", "width", "x", "y", "page", "recipient_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["api_id", "height", "required", "type", "value", "width", "x", "y", "page", "recipient_id", ], str]):
    ...
    ) -> 'DocumentUpdateAndSendResponseFieldsItemItem':
        return super().__new__(
            cls,
            *args,
            api_id=api_id,
