...
from sign_well_python_sdk.pydantic.document_template_response_fields_item_item_recipient import DocumentTemplateResponseFieldsItemItemRecipient

class DocumentTemplateResponseFieldsItemItem(BaseModel):
    ...
    recipient: typing.Optional[DocumentTemplateResponseFieldsItemItemRecipient] = Field(None, alias='recipient')
