...
from sign_well_python_sdk.pydantic.document_create_from_template_response_recipients_item_attachment_requests import DocumentCreateFromTemplateResponseRecipientsItemAttachmentRequests

class DocumentCreateFromTemplateResponseRecipientsItem(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    attachment_requests: typing.Optional[DocumentCreateFromTemplateResponseRecipientsItemAttachmentRequests] = Field(None, alias='attachment_requests')
