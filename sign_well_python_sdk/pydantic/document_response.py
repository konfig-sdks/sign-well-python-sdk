...
from sign_well_python_sdk.pydantic.document_response_attachment_requests import DocumentResponseAttachmentRequests
from sign_well_python_sdk.pydantic.document_response_copied_contacts import DocumentResponseCopiedContacts
from sign_well_python_sdk.pydantic.document_response_fields import DocumentResponseFields
from sign_well_python_sdk.pydantic.document_response_files import DocumentResponseFiles
from sign_well_python_sdk.pydantic.document_response_recipients import DocumentResponseRecipients
...
class DocumentResponse(BaseModel):
    ...
    recipients: typing.Optional[DocumentResponseRecipients] = Field(None, alias='recipients')
    ...
    attachment_requests: typing.Optional[DocumentResponseAttachmentRequests] = Field(None, alias='attachment_requests')

    files: typing.Optional[DocumentResponseFiles] = Field(None, alias='files')

    copied_contacts: typing.Optional[DocumentResponseCopiedContacts] = Field(None, alias='copied_contacts')

    fields: typing.Optional[DocumentResponseFields] = Field(None, alias='fields')
