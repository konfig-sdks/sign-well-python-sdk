...
from sign_well_python_sdk.pydantic.bulk_send_get_documents_response_documents_item_recipients_item_attachment_requests import BulkSendGetDocumentsResponseDocumentsItemRecipientsItemAttachmentRequests

class BulkSendGetDocumentsResponseDocumentsItemRecipientsItem(BaseModel):
    ...
    attachment_requests: typing.Optional[BulkSendGetDocumentsResponseDocumentsItemRecipientsItemAttachmentRequests] = Field(None, alias='attachment_requests')
