...
from sign_well_python_sdk.pydantic.document_from_template_response_fields_item_item_recipient import DocumentFromTemplateResponseFieldsItemItemRecipient

class DocumentFromTemplateResponseFieldsItemItem(BaseModel):
    ...
    recipient: typing.Optional[DocumentFromTemplateResponseFieldsItemItemRecipient] = Field(None, alias='recipient')
