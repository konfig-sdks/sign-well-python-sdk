...
from sign_well_python_sdk.pydantic.template_create_new_response_placeholders_item_attachment_requests import TemplateCreateNewResponsePlaceholdersItemAttachmentRequests

class TemplateCreateNewResponsePlaceholdersItem(BaseModel):
    ...
    attachment_requests: typing.Optional[TemplateCreateNewResponsePlaceholdersItemAttachmentRequests] = Field(None, alias='attachment_requests')
