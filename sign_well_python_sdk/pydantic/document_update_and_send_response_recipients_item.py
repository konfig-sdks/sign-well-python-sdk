...
from sign_well_python_sdk.pydantic.document_update_and_send_response_recipients_item_attachment_requests import DocumentUpdateAndSendResponseRecipientsItemAttachmentRequests

class DocumentUpdateAndSendResponseRecipientsItem(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    attachment_requests: typing.Optional[DocumentUpdateAndSendResponseRecipientsItemAttachmentRequests] = Field(None, alias='attachment_requests')
