...
from sign_well_python_sdk.pydantic.document_recipients_map import DocumentRecipientsMap
from sign_well_python_sdk.pydantic.expires_in_map import ExpiresInMap
from sign_well_python_sdk.pydantic.fields_map import FieldsMap
from sign_well_python_sdk.pydantic.files_map import FilesMap

class DocumentRequest(BaseModel):
    files: FilesMap = Field(alias='files')

    recipients: DocumentRecipientsMap = Field(alias='recipients')
    ...
    fields: typing.Optional[FieldsMap] = Field(None, alias='fields')
