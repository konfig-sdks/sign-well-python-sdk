...
from sign_well_python_sdk.pydantic.document_send_reminder_response_recipients_item_attachment_requests import DocumentSendReminderResponseRecipientsItemAttachmentRequests

class DocumentSendReminderResponseRecipientsItem(BaseModel):
    ...
    attachment_requests: typing.Optional[DocumentSendReminderResponseRecipientsItemAttachmentRequests] = Field(None, alias='attachment_requests')
